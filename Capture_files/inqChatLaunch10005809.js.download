/* Timestamp: Wed Mar 11 22:31:39 PDT 2020 , Code Version: 1583991086908 */
...
window.v3Lander={FRAME_ID:"inqChatStage",codeVersion:'1583991086908',v3Frame:false,domState:"defer-failed",domReady:false,secureProtocol:function(url){return url.replace(/^HTTPS?:/i,"https:");},hostToPath:{},hostedFileURL:getV3LanderConfigProperty("hostedFileURL","/nuance/nuance-chat.html"),isAtHostedFileURL:false,vanityDomain:'https://shutterstock.inq.com',log:function(s){if(typeof console!="undefined"&&console.log){console.log(s);}},FMProxy:{fcns:{},addFcn:function(name,fcnStr){var obj=null;try{obj=eval("({'"+name+"':"+fcnStr+"})");}
